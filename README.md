...
Implementação em Prolog de processamento sintático pela Gramática de Cláusula Definida, com funções gramaticais, restrições de gênero, número e tempo, informações estruturais e aplicação do artigo-nu.
